...
BlocksApp.controller("MainController", [
  "$scope",
  "$rootScope",
...
BlocksApp.controller("HeaderController", [
  "$scope",
  "$location",
  "setupObj",
  function ($scope, $location, setupObj) {
    $scope.$on("$includeContentLoaded", function () {
      Layout.initHeader(); // init header
    });
    $scope.form = {};

    $scope.isActive = function (hLink) {
      if (hLink === $location.$$url) return true;
    };
    ...
    $scope.searchQuery = function (s) {
      ...
      if (isAddress(search)) $location.path("/addr/" + search);
      else if (isTransaction(search)) $location.path("/tx/" + search);
      else if (!isNaN(search)) $location.path("/block/" + search);
      else $scope.form.searchInput = search;
    };
...
/* Search Bar */
BlocksApp.controller("PageHeadController", [
  "$scope",
  "setupObj",
  function ($scope, setupObj) {
    $scope.$on("$includeContentLoaded", function () {});
    setupObj.then(function (res) {
      $scope.settings = res;
    });
...
BlocksApp.controller("FooterController", [
  "$scope",
  "setupObj",
  function ($scope, setupObj) {
    $scope.$on("$includeContentLoaded", function () {
          ...
          deps: [
            ...
            function ($ocLazyLoad) {
              return $ocLazyLoad.load({
                name: "BlocksApp",
                insertBefore: "#ng_load_plugins_before", // load the above css files before '#ng_load_plugins_before'
                files: ["/js/controllers/BlockController.js"],
              });
            },
          ],
        },
          ...
          deps: [
            ...
            function ($ocLazyLoad) {
              return $ocLazyLoad.load({
                name: "BlocksApp",
                insertBefore: "#ng_load_plugins_before", // load the above css files before '#ng_load_plugins_before'
                files: ["/js/controllers/UncleController.js"],
              });
            },
          ],
        },
          ...
          deps: [
            ...
            function ($ocLazyLoad) {
              return $ocLazyLoad.load({
                name: "BlocksApp",
                insertBefore: "#ng_load_plugins_before", // load the above css files before '#ng_load_plugins_before'
                files: ["/js/controllers/TxController.js"],
              });
            },
          ],
        },
          ...
          deps: [
            ...
            function ($ocLazyLoad) {
              return $ocLazyLoad.load({
                name: "BlocksApp",
                insertBefore: "#ng_load_plugins_before",
                files: ["/js/controllers/TokenListController.js"],
              });
            },
          ],
        },
          ...
          deps: [
            ...
            function ($ocLazyLoad) {
              return $ocLazyLoad.load({
                name: "BlocksApp",
                insertBefore: "#ng_load_plugins_before",
                files: ["/js/controllers/TokenController.js"],
              });
            },
          ],
        },
          ...
          deps: [
            ...
            function ($ocLazyLoad) {
              return $ocLazyLoad.load({
                name: "BlocksApp",
                insertBefore: "#ng_load_plugins_before",
                files: ["/js/controllers/ErrController.js"],
              });
            },
          ],
        },
...
BlocksApp.run([
  ...
  "$state",
  "setupObj",
  function ($rootScope, settings, $state, setupObj) {
